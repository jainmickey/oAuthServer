...
APPS_DIR = ROOT_DIR.path('auth_server')
...
ADMINS = (
    ('oAuthServer Admin', 'mayank@fueled.com'),
)
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'auth_server.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "auth_server.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/auth_server"),
}
