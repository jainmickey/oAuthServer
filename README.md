...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:jainmickey93/oAuthServer.git; cd oAuthServer; fab init
...
[contributing]: http://github.com/jainmickey93/oAuthServer/tree/master/CONTRIBUTING.md
